...
report_clock_tree > reports/fifo_pre_cts_tree.rpt
...
report_clock_tree > reports/fifo_pre_clock_route_tree.rpt
...
all_high_fanout -nets -threshold 500 > reports/fifo_cts_high_fanout.rpt
